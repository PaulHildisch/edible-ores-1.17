...
public class ModItems {
    ...
    private static final Item POPCORN = new Item(new Item.Settings().group(EdibleOres.ITEM_GROUP).food(new FoodComponent.Builder().hunger(6).saturationModifier(8f).snack().build()));
