...
public class ModItems {
    ...
    private static final Item CANDYCANE = new Item(new Item.Settings().group(ItemGroup.MISC));
    private static final Item BUTTER = new Item(new Item.Settings().group(ItemGroup.MISC).maxCount(6));
